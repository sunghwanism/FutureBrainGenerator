...
class AdaBrainLDM(nn.Module):
    ...
    def __init__(
        ...
        num_head_channels: Sequence[int] = 8,
        with_conditioning: bool = False,
        transformer_num_layers: int = 1,
        cross_attention_dim: int = None,
        clinical_condition: Sequence[str] = None,
        ...
        if clinical_condition is not None:
            ...
            for c_cond in self.clinical_condition:
                if c_cond == 'Sex':
                    self.condition_emb_dict[c_cond] = nn.Sequential(nn.Embedding(2, time_embed_dim),
