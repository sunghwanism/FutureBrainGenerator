...
def get_run_parser():
    ...
    # Hyperparameters
    parser.add_argument('--diff_num_channels', type=int, nargs='+', default=(8, 16),
                        help="List of channel sizes")
    parser.add_argument('--diff_num_res_blocks', type=int, default=(1, 1))
    parser.add_argument('--diff_num_head_channels', type=int, nargs='+', default=(0, 16),)
    parser.add_argument('--diff_attention_levels', type=int, nargs='+', default=(0, 1),)
